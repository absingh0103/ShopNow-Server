...
const subCategories = [
  { name: "GTA V", link: "/product-details/65298c848b828516f07d2dce" },
  { name: "MacBook Pro", link: "/product-details/65298c848b828516f07d2d6f" },
  { name: "iphone X", link: "/product-details/65298c848b828516f07d2d6b" },
  { name: "Watch", link: "/product-details/65298c848b828516f07d2da8" },
  { name: "Handbag", link: "/product-details/65298c848b828516f07d2db1" },
];
...
const ProductList = () => {
  ...
  const handleFilter = (e, section, option) => {
    // to Support multiple Category We need to make changes in this code
  ...
  return (
    <div>
      <div>
        <div className="bg-gradient-to-r from-rose-100 to-teal-100 mb-10">
          <div>
              ...
              <div className="flex items-baseline justify-between border-b border-gray-300 pb-6 pt-14">
                <h1 className="text-3xl lg:text-5xl cursor-pointer font-bold font-mono tracking-tight text-rose-600 ">
                  ...
                  <img
                    src="../AuthIcon.png"
                    alt=""
                    className="w-10 h-8 ml-1 lg:ml-3 inline animate-bounce"
                  />
                </h1>
          ...
          >
            <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-gradient-to-r from-rose-100 to-teal-100 py-4 pb-12 shadow-xl">
              ...
              <form className="mt-4 border-t border-gray-200 bg-gradient-to-r from-rose-100 to-teal-100">
                ...
                >
                  <p className="text-rose-500 font-bold font-mono text-xl animate-pulse  ">Fetaured Products</p>
                  {subCategories.map((category) => (
                    <li key={category.name}>
                      <Link to={category.link} className="block text-sm text-orange-500 px-2 py-1">
                        {category.name}
                      </Link>
                    </li>
                  ))}
...
const ProductGridComponenet = ({ products, status }) => {
  ...
  return (
    <div className="lg:col-span-3">
      ...
      <div className="bg-rose-100 shadow rounded-md pb-3">
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
              ...
              {products && products.map((product) => (
                ...
                <Link to={`/product-details/${product.id}`}>
                  <div
                    key={product.id}
                    className="group relative border-solid border-2 border-rose-200 rounded-xl p-1"
                  >
