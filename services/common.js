// ! It will Call Everytime whenever a Protected Api is Called To Check Authentication
...
const isAuth = (req, resp, done) => {
  return passport.authenticate("jwt");
};

// TO Return Only Id And Role
const authInfo = (user) => {
...
// For Mail Using NodeMailer
// We Define Mail send Here to prevent From Easy Access to Mail
const transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    user: "abhiishekkumarsingh@gmail.com",
...
const SendMail = async ({ to, subject, html, text }) => {
  ...
  const info = await transporter.sendMail({
    from: '"ShopNow" <abhiishekkumarsingh@gmail.com>', // sender address
    to,
    subject,
    html,
    text,
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="center" valign="top" style="padding: 36px 24px;">
              <a href="https://shopnow.com" target="_blank" style="display: inline-block;">
                <img src="https://scontent.fdel52-1.fna.fbcdn.net/v/t1.6435-9/42705317_2006153416341874_5204605910042804224_n.png?_nc_cat=109&ccb=1-7&_nc_sid=947906&_nc_ohc=xjUf18E3X1kAX_GiKrj&_nc_ht=scontent.fdel52-1.fna&oh=00_AfAVGJBnEa5MrxVNbneuKnjJNUZcVQTjLhFi059diezJZQ&oe=65828A7F" alt="ShopNow" border="0"  style="display: block; max-width: 100px; min-width: 100px;">
              </a>
            </td>
          </tr>
        </table>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <p style="margin: 0;">Here is a summary of your recent order. If you have any questions or concerns about your order, please <a href="abhiishekkumarsingh@gmail.com">contact us</a>.</p>
            </td>
          </tr>
          <!-- end copy -->
          ...
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                ${order.cartItems.map(
                  (item) => `<tr>
                  <td align="left" width="60%" style="padding: 6px 12px; display: flex;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><img src=${item.product.thumbnail} alt="ShopNow" border="0"  style="display: flex; max-width: 30px; min-width: 30px;">&nbsp;&nbsp;${
                    item.product.title
                  }</td>
    ...
    order.selectedAddress.pinCode
               ...
               <div style="display: inline-block; width: 100%; max-width: 50%; min-width: 240px; vertical-align: top;">
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      <p><strong>ShopNow Address</strong></p>
                      <p>Ground Floor <br> Eros Plaza <br> Eros Corporate Centre<br> Nehru Place, New Delhi-110019</p>
                    </td>
                  </tr>
                </table>
              </div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td align="center" bgcolor="#D2C7BA" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
              <p style="margin: 0;">You received this email because we received a request for an ORDER from your account. If you didn't request you can safely delete this email.</p>
            </td>
          </tr>
          <!-- end permission -->
...
module.exports = { isAuth, authInfo, cookieExtractor, SendMail, orderInvoice };
